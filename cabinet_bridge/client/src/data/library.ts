...
export const SYSTEMS: System[] = [
  ...
  },
  {
    ...
    era: "1977",
    count: 565,
    art: ["25 88% 46%", "18 92% 36%"],
    slug: "atari2600",
    mono: "2600",
    image: systemImage("atari2600"),
  },
  {
    id: "saturn",
    name: "Sega Saturn",
    ...
    era: "1994",
    count: 1058,
    art: ["210 55% 28%", "220 65% 42%"],
    slug: "saturn",
    mono: "SAT",
    image: systemImage("saturn"),
  },
  {
    id: "gamegear",
    name: "Sega Game Gear",
    ...
    era: "1990",
    count: 363,
    art: ["155 55% 28%", "165 65% 40%"],
    slug: "gamegear",
    mono: "GG",
    image: systemImage("gamegear"),
  },
  {
    id: "sms",
    name: "Sega Master System",
    shortName: "Master Sys.",
    era: "1985",
    count: 326,
    art: ["195 62% 24%", "205 72% 38%"],
    slug: "sms",
    mono: "SMS",
    image: systemImage("sms"),
  },
  {
    id: "pce",
    name: "TurboGrafx-16",
    shortName: "TurboGrafx",
    era: "1987",
    count: 678,
    art: ["275 55% 32%", "265 65% 46%"],
    slug: "pce",
    mono: "PCE",
